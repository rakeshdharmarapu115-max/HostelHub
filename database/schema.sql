-- ============================================================================
-- Hostel Management System (HostelHub) - Database Schema
-- Compatible with PostgreSQL, SQLite, and MySQL/MariaDB
-- ============================================================================

-- Enable foreign keys (For SQLite execution)
...
-- ----------------------------------------------------------------------------
-- 3. Hosts (Wardens / Hostel Owners) Table
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 4. Admins (Campus Housing Authorities) Table
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 11. Room Allocations Table (Allocation, Transfer & History)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 12. Staff Table (Maintenance & Operations)
-- ----------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS food_menus (
    ...
    hostel_id VARCHAR(100) NOT NULL,
    week_start_date VARCHAR(20) NOT NULL, -- YYYY-MM-DD
